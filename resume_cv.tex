...
\name{Michael G}{McKinney}
\address{Pittsburgh PA 15217}
\mobile{412-260-2628}

\email{mgmckinney@gmail.com}
\linkedin{mgmckinney}
\github{mgmckinney}
...
\makecvfooter{\today}{Michael G McKinney~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
